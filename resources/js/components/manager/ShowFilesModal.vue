        ...
        <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow">
                <button
                    ...
                    data-modal-toggle="show-files-modal"
                    type="button"
                    @click="clearData">
                ...
                <div class="py-6 px-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900">Загрузка файлов для шаблона:</h3>
                    <form action="#" class="space-y-4">

                        <ur-template-file-fields ref="urTemplateFields"
                                                 @filesInput="(incomingFiles) => this.files = incomingFiles"></ur-template-file-fields>
...
<script>
import UrTemplateFileFields from "./TemplatesForm/UrTemplateFileFields";
import FileInput from "./TemplatesForm/FileInput";
import ShowUploadedFiles from "./TemplatesForm/ShowUploadedFiles";
import fileDownload from "js-file-download";

export default {
    components: {ShowUploadedFiles, FileInput, UrTemplateFileFields},
    props: ['selectedItem'],
    data() {
        return {
            files: undefined,
    ...
    methods: {
        fetch() {
            ...
            axios.get(`/api/${apiLocation}/company/templates/${templateId}/files`).then(function (response) {
        ...
        sendFiles() {
            ...
            for (const [key, value] of Object.entries(this.files)) {
                ...
                axios.post(`/api/${apiLocation}/company/templates/${templateId}/files/store`, formData, {
                    headers: {
        ...
        downloadFile(fileId) {
            ...
            axios.get(`/api/${apiLocation}/company/templates/files/${fileId}/show`, {responseType: "blob"}).then(function (response) {
        ...
        deleteFile(fileId) {
            ...
            axios.delete(`/api/${apiLocation}/company/templates/files/${fileId}/delete`, {responseType: "blob"}).then(function (response) {
                vue.fetch();
                alert('Успешно');
            }).catch(function (error) {
                console.log(error.response);
