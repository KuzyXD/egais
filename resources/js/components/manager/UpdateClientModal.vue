        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow">
                <button
                    ...
                    data-modal-toggle="update-client-modal"
                    type="button"
                    @click="clearData">
                ...
                <div class="py-6 px-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900">Создать клиента:</h3>
                    <form action="#" class="space-y-6">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900">Фамилия, имя и отчество:</label>
                            <input id="fio"
                                   v-model="form.fio"
                        ...
                        <p class="text-sm text-gray-500">При нажатии кнопки "Готово" клиент создастся автоматически.</p>
                        <button
...
export default {
    ...
    methods: {
        fetch() {
            ...
            axios.get(`/api/${apiLocation}/client/${clientId}/show`).then(function (response) {
                vue.form = response.data.data;
                vue.form.certificate_expire_to_date = formatYmd(new Date(vue.form.certificate_expire_to_date))
